Shader "Roystan/Toon/Water Tut"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // Sample depth using tex2Dproj
                float sceneZ = UNITY_SAMPLE_DEPTH(tex2Dproj(_CameraDepthTexture, UNITY_PROJ_COORD(i.screenPosition)));
                float existingDepth01 = Linear01Depth(sceneZ);
                float existingDepthLinear = LinearEyeDepth(sceneZ);
